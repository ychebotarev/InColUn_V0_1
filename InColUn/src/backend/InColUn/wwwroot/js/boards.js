...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = (function () {
	    function App() {
	        ...
	        this.SetCommandDispatcher('NewBoard', function () { _this.NewBoard(); });
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BoardsContext = (function (_super) {
	    ...
	    BoardsContext.prototype.RenderBoards = function (self) {
	        ...
	        add_board.innerHTML = '  <span>Create New Board</span><div><img src="images/new_board.png"></div><i class="btn" data-toggle="modal" data-target="#myModal">+</i>';
